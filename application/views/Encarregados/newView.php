...
<body>
	...
	<div id="container">
		<div class="jumbotron">
		<h1>Adicionar Encarregado</h1><br><br><br>



	<div class="container">
      
<?php echo form_open(base_url() . 'index.php/encarregados/novoencarregado/'); ?>

<div class="form-group col-md-6 offset-md-3 formadmin">
    <br>
    <label>Tipo de Utilizador:</label>
    <input type="text" name="ID_User" value="" class="form-control" placeholder="Tem de ser 4!">
    <label>Nome do Encarregado:</label>
    <input type="text" name="NomeEncarregado" value="" class="form-control" >
    <label>Contacto:</label>
    <input type="text" name="ContactoEncarregado" value="" class="form-control" >
    <label>Morada:</label>
    <input type="text" name="MoradaEncarregado" value="" class="form-control" >
